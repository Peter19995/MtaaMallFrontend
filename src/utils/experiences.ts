...
export const platformModules: WorkspaceModule[] = [
  ...
  { path: 'catalog', label: 'Catalogue overview', permission: 'catalog.products.review' },
  { path: 'catalog/proposals', label: 'Catalogue proposals', permission: 'catalog.products.review' },
  { path: 'catalog/products', label: 'Global products', permission: 'catalog.products.review' },
  { path: 'catalog/categories', label: 'Global categories', permission: 'catalog.categories.read' },
  { path: 'catalog/brands', label: 'Global brands', permission: 'catalog.brands.read' },
  { path: 'catalog/duplicates', label: 'Duplicate review', permission: 'catalog.products.review' },
...
export function canAccessWorkspace(user: WorkspacePrincipal | null, path: string) {
  ...
  const module = experience === 'platform' && /^businesses\/[^/]+\/payments$/.test(suffix)
    ...
    ? { path: suffix, label: 'Product proposals', permission: 'catalog.products.propose', mutation: true }
